...
var app = (function () {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			a.textContent = "Login";
    			attr_dev(button, "class", "svelte-skdrqe");
    			add_location(button, file$1, 62, 8, 1967);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "svelte-skdrqe");
    			add_location(a, file$1, 65, 12, 2075);
    			attr_dev(p, "class", "svelte-skdrqe");
    			add_location(p, file$1, 63, 8, 2020);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			t2 = text("Dont have an account?\r\n            ");
    			a = element("a");
    			a.textContent = "Sign up";
    			attr_dev(button, "class", "svelte-skdrqe");
    			add_location(button, file$1, 56, 8, 1735);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "svelte-skdrqe");
    			add_location(a, file$1, 59, 12, 1836);
    			attr_dev(p, "class", "svelte-skdrqe");
    			add_location(p, file$1, 57, 8, 1784);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "svelte-skdrqe");
    			add_location(p, file$1, 70, 8, 2217);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    ...
    function create_fragment$2(ctx) {
    	let main;
    	let h1;
    	let t0_value = (/*isLogin*/ ctx[3] ? 'Login' : 'SignUp') + "";
    	let t0;
    	let t1;
    	let input0;
    	let t2;
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*isLogin*/ ctx[3]) return create_if_block_1;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 50, 4, 1512);
    			attr_dev(input0, "type", "email");
    			attr_dev(input0, "placeholder", "email@email.com");
    			attr_dev(input0, "class", "svelte-skdrqe");
    			add_location(input0, file$1, 52, 4, 1559);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "placeholder", "Password1!");
    			attr_dev(input1, "class", "svelte-skdrqe");
    			add_location(input1, file$1, 53, 4, 1634);
    			attr_dev(main, "class", "svelte-skdrqe");
    			add_location(main, file$1, 49, 0, 1500);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*isLogin*/ 8 && t0_value !== (t0_value = (/*isLogin*/ ctx[3] ? 'Login' : 'SignUp') + "")) set_data_dev(t0, t0_value);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	async function signUp() {
    		try {
    			...
    			if (data.success) {
    				$$invalidate(2, message = 'Signup succesful!');
