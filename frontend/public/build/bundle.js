    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 80, 8, 2348);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "svelte-skdrqe");
    			add_location(a, file$1, 83, 12, 2455);
    			attr_dev(p, "class", "svelte-skdrqe");
    			add_location(p, file$1, 81, 8, 2400);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-skdrqe");
    			add_location(button, file$1, 71, 8, 2072);
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "svelte-skdrqe");
    			add_location(a, file$1, 74, 12, 2174);
    			attr_dev(p, "class", "svelte-skdrqe");
    			add_location(p, file$1, 72, 8, 2121);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "svelte-skdrqe");
    			add_location(p, file$1, 91, 8, 2645);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	async function signUp() {
    		try {
    			...
    			if (data.success) {
    				$$invalidate(2, message = "Signup successful! You can now log in.");
